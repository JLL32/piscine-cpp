...
AForm* Intern::makeForm(const std::string &form, const std::string &target) {
    ...
    (form == "Shrubbery Creation Form") && (formFunc = &Intern::makeShrubbery);
    (form == "Robotomy Request Form") && (formFunc = &Intern::makeRobotomy);
    (form == "Presidential Pardon Form") && (formFunc = &Intern::makePresidential);
    if (formFunc == nullptr)
